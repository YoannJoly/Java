...
public class Binaire {
    ...
    private static int bin2dec(final String bin) throws InvalidPropertiesFormatException {
        ...
        for (int i = 0; i < bin.length(); i++) {
            ...
            final int mutliplicator = Integer.parseInt("" + bin.charAt(bin.length() - 1 - i));

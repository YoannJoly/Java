...
import tp9_2_interface_difficilles.entites.Credit;
import tp9_2_interface_difficilles.entites.Debit;
import tp9_2_interface_difficilles.entites.Operation;
...
public class TestOperation {
    ...
    public static void main(String[] args) {
        Operation[] operations = { new Credit("01/26/12", 236), new Credit("26/11/18", 1230),
